  ...
  let productFeatures = [
    {
      ...
      description: "Champion's Fitness ensures all users have the information they need to train safely and train effectively.",
      ...
      <div class="flex flex-col gap-2">
        ...
        {#each productFeatures as productFeature, index}
          <ProductCard {productFeature} {index}>
              ...
              {:else if index === 1}
              Lay the foundations for <br/><span class="text-indigo-400 font-medium">routine</span> and consistency
              {:else}
